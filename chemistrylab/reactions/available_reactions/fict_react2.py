...
conc_coeff_arr = 10*np.array(
    [ #  r0    r1    r2   r3
        [-5.0, -1.0, 0.0, 0.0], # concentration calculation coefficients for A
        [-5.0, 0.0, -1.0, 0.0], # concentration calculation coefficients for B
        ...
        [5.0, 0.0, 0.0, 0.0], # concentration calculation coefficients for E
