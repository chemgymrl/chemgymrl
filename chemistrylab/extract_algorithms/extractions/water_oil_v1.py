...
class Extraction:
    ...
    def __init__(
        ...
        max_vessel_volume=1,  # max volume of empty vessels L
    ...
    def get_observation_space(self,targets):
        #added targets as parameter (targets increases the size of the obs space) -KS
    ...
    def reset(self, extraction_vessel,targets):
        #added targets as parameter (used in making observations) -KS
