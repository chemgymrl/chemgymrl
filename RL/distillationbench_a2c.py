...
#results_plotter.plot_results([log_dir], time_steps, results_plotter.X_TIMESTEPS, "A2C Distillation Bench")
x, y = ts2xy(load_results(log_dir), 'timesteps')
#print("The value of y are", y)
fig = plt.figure("A2C Distillation Bench")
plt.plot(x,y)
plt.xlabel('Number of Timesteps')
plt.ylabel('Rewards')
#results_plotter.plot_curves([x,y], results_plotter.X_TIMESTEPS, "A2C Distillation bench")
#print("the value of y are", y)
title = "A2C Distillation Bench"
plt.title(title)
plt.savefig('./A2Cdistillationbench.png')
