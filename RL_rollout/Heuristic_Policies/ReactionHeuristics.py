...
class FictReact1Heuristic(Heuristic):
    def predict(self,observation,a=0.91378666,b=0.92011728,thresh=0.093):
        ...
        if t==4:
            marker=observation[0,:100].mean()
            #print(marker)
            if marker<0.01:
                #dump in a little bit of A+B and D so it's all used up
                return np.array([1,a,b,0,1,1,1,0]),[]# make F
